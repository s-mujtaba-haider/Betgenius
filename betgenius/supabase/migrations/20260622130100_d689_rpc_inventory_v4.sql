-- D-689 — RPC inventory v4: matches src/pages/Dashboard.tsx MARKET_FACTOR_COLS
-- post D-689 restoration of all 43 D-684 removals (gates widened in
-- scoring_mlb_v2.ts; SO market restored despite dormant data feed).
