...
BEGIN
  ...
  SELECT net.http_post(
    ...
    body := jsonb_build_object('startDate', '2026-04-25', 'endDate', '2026-04-25', 'sport', 'nba',
      'dryRun', false, 'requireServiceRoleKey', true, 'skipInjuryFetch', true,
      'algorithmVersion', '2026-05-11-phase3e-verify'),
    timeout_milliseconds := 120000
  ) INTO v_request_id;
  RAISE NOTICE 'Phase 3e invoked: request_id=%', v_request_id;
END $$;
