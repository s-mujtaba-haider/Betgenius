-- D-816 — Extend upsert_pick_history RPC INSERT + DO UPDATE SET to persist
-- 4 new columns: score_batter_pull_rate (PART 1) + 3 promoted columns
-- (score_pitcher_gb_fb_rate, score_pitcher_hr_per_9, score_wind_direction_hr —
-- PART 3 promote-from-breakdown-only).
--
-- Companion to 20260628300000. Pure additive. Every other field preserved
-- byte-for-byte from D-808.
...
BEGIN
  ...
  INSERT INTO public.pick_history (
    ...
    -- D-816 — 4 new HR-focused columns
