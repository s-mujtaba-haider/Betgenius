-- D-689 SHIP 1B.2 — un-pause fetch-mlb-pitcher-pen-extras-daily (covers
-- game_side.score_pen_rest_v3). Reads original schedule from snapshot.
DO $$
DECLARE
  v_schedule TEXT; v_command TEXT;
  v_jobname TEXT := 'fetch-mlb-pitcher-pen-extras-daily';
BEGIN
  ...
  VALUES ('restored', v_jobname, 'D-689 restore for pen_rest_v3');
