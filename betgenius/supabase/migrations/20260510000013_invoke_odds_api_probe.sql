-- Invoke odds-api-injuries-probe (May 11, 2026).
DO $$
DECLARE
  v_token TEXT;
  v_request_id BIGINT;
BEGIN
  ...
  SELECT net.http_post(
    url := 'https://gzuzuqxvfjszlfclhcfz.supabase.co/functions/v1/odds-api-injuries-probe',
  ...
  RAISE NOTICE 'probe request_id=%', v_request_id;
END $$;
