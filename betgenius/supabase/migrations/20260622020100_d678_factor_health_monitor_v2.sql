-- D-678 second-pass — sync RPC inventory with src/pages/Dashboard.tsx
-- MARKET_FACTOR_COLS after the 5 additional removals
-- (batter_rbis.score_pitcher_gb_fb_rate, batter_rbis.score_pitcher_hr_per_9,
-- pitcher_k.score_weather_wind, game_side.score_k_matchup_v2,
-- game_total.score_umpire_k_zone).
...
DECLARE
  ...
  v_inventory JSONB := jsonb_build_object(
    ...
    'pitcher_k',          jsonb_build_array('score_pitcher_k_rate','score_pitcher_form','score_opposing_lineup_k','score_handedness_matchup','score_pitch_count_trend','score_rest_pitcher','score_ballpark_factor','score_weather_temp','score_umpire_k_zone','score_pitcher_command_trend','score_pitcher_velocity_trend','score_lineup_k_composition','score_pitch_type_matchup','score_pitcher_xera_edge','score_pitcher_baa','score_catcher_framing','score_pitcher_pitch_mix_k','score_pitcher_whiff_skill_v2'),
