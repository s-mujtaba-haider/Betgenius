-- Re-trigger Phase 3 Apr 25 backfill after placement-bug fix (commit b2a7c42).
...
BEGIN
  ...
  SELECT net.http_post(
    ...
    body := jsonb_build_object(
      ...
      'algorithmVersion', '2026-05-11-phase3b-verify'
    ),
    timeout_milliseconds := 120000
  ) INTO v_request_id;
  RAISE NOTICE 'Phase 3b Apr 25 backfill invoked: request_id=%', v_request_id;
END $$;
