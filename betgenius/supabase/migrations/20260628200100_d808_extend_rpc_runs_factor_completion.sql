-- D-808 — Extend upsert_pick_history RPC INSERT + DO UPDATE SET to persist
-- 6 new runs_scored factor columns. Without this RPC extension,
-- jsonb_populate_record drops the values at INSERT VALUES boundary
-- (D-742/D-758/D-785/D-803/D-807 silent-drop class).
--
-- Pure additive. Every other field preserved byte-for-byte from D-807.
...
BEGIN
  ...
  INSERT INTO public.pick_history (
    ...
    -- D-808 — 6 new runs_scored factor columns
